...
// informers holds and starts each informer used by the V2 Build Controller.
...
// start starts all informer factories, wiring them up to the provided context.
...
// listers instantiates the required listers from the informers.
...
// listers holds all of the required listers so they can be passed around and reused.
type listers struct {
...
// utilListers converts the internal listers to the utils.Listers format.
...
// newInformers creates new informer instances from the given clients.
