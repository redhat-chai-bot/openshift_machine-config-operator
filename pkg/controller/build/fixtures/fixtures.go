...
// objects in them.
func GetClientsForTest(t *testing.T) (*fakecorev1client.Clientset, *fakeclientmachineconfigv1.Clientset, *ObjectsForTest, *testhelpers.Assertions) {
...
// pool name "worker".
func GetClientsForTestWithAdditionalObjects(t *testing.T, addlKubeObjects, addlMcfgObjects []runtime.Object) (*fakecorev1client.Clientset, *fakeclientmachineconfigv1.Clientset, *ObjectsForTest, *testhelpers.Assertions) {
